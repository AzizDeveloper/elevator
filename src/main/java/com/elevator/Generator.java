...
public class Generator {
     ...
     */
    public static Set<Person> peopleGenerator(int currentFloor, int minPeopleCount,
                                              int maxPeopleCount, int maxFloors)  {
     ...
     */
    public static List<Floor> floorsGenerator(int minPeopleCount, int maxPeopleCount,
                                              int minFloorsCount, int maxFloorsCount) {
